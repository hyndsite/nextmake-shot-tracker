...
- Add AAU competition level selection for `AAU / Travel`.
...
- Show a conditional second dropdown based on the selected category:
  ...
  - `AAU / Travel` => season picker + competition level picker
...
- `AAU / Travel` season choices are:
  ...
  - `Summer`
  - `Fall`
- `AAU / Travel` competition level choices are:
  - `Kindergarten`
  - `1st Grade`
  - `2nd Grade`
  - `3rd Grade`
...
- `aau_season`
  ...
  - `Summer`
  - `Fall`
- `aau_competition_level`
  - one of the approved AAU competition labels
...
- Build `level` from the structured fields when saving a game session:
  ...
  - `K-12 · 7th Grade`
  - `College · 2025-26`
  - `AAU / Travel · Summer · 7th Grade`
  - `Other`

## Validation Rules
- `level_category = k_12` requires `level_grade`.
- `level_category = college` requires `college_season`.
- `level_category = aau` requires `aau_season` and `aau_competition_level`.
